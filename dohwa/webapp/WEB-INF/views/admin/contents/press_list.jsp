...
<body>
	<div class="wrap"><a href="#contents" class="skip">본문바로가기</a>
		...
		<div id="container">
			...
			<div class="wrap-cont">
				<h2 style="margin-bottom: 50px;">보도자료 관리 조회</h2>
				<form:form id="form" modelAttribute="searchVO" method="get" action="/admin/contents/press">
					...
					<div class="wrap-tb tb-list">
						<table>
							...
							<c:forEach items="${pressList }" var="list" varStatus="sts">
								...
								<tr>
									...
									<td style="text-align: left;">
										<a href="#" onclick="return false;" data-url="/admin/contents/press/save/${list.seq }"><c:out value="${list.title }" /></a>
									</td>
							...
							<c:if test="${fn:length(pressList) <= 0 }">
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('[insert-btn]').on('click', function() {
				...
				goViewPage('/admin/contents/press/save');
			});	
			...
			$('[delete-btn]').on('click', function() {
				...
				if (confirm('<spring:message code="ADMIN.VALIDATE.DELETE.CONFIRM" javaScriptEscape="true" />')) {
					...
					$('#form').attr('method', 'post').attr('action', '/admin/contents/press/delete').submit();
				}
			});
		});
