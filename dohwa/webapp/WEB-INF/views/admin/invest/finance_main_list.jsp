...
<body>
	<div class="wrap"><a href="#contents" class="skip">본문바로가기</a>
		...
		<div id="container">
			...
			<div class="wrap-cont">
				<h2 style="margin-bottom: 50px;">투자정보 관리 > 재무정보 > 주요경영실적 조회</h2>
				<form:form id="form" modelAttribute="searchVO" method="post">
					...
					<div class="bx-btn a-right">
						...
						<a class="btns btn-line-g" href="/admin/invest/finance/main/0"><span>등록</span></a>
					</div>
					<div class="bx-btn a-right">
							...
							<tbody>
								...
								<c:if test="${not empty list}">
									...
									<tr>
										...
										<td><a href="/admin/invest/finance/main/<c:out value="${row.yyyy }"/>"><c:out value="${row.yyyy }"/></a></td>
										<td>
	...
	(function ($) {
		...
		$('#deleteButton').on('click', function(e) {
			...
			$.ajax({
				url : '/admin/invest/finance/main/delete',
				type : 'post',
				data : {
