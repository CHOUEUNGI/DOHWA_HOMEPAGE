						...
						<div class="contents no-btm-type clfix">
							...
							<div class="section-cont">
								<div class="etc-policy-desc">
									<!--s: 20200914 텍스트 수정-->
									<div class="nanumR">
										<p>주식회사 도화엔지니어링(이하 "회사"라고 함)은 이용자의 개인 정보를 매우 소중하게 생각하고 있으며, '정보통신망 이용 촉진 및 정보보호에 관한 법률'을 준수하고 있습니다.</p>
										<p>회사는 이용자의 개인 정보가 어떠한 목적과 방식으로 이용되고 있으며, 이용자의 개인 정보보호를 위해 어떠한 조치가 취해지고 있는지 아래와 같이 알려드립니다.</p>
										<p>회사는 개인정보 취급방침 내용을 개정 또는 업데이트하는 경우, 웹사이트 공지 또는 개별 공지를 통해 개정 또는 업데이트 사항을 알려드릴 것입니다.</p>
										<p>다음 개인정보 취급방침은 이 웹사이트 (www.dohwa.co.kr, "본 사이트")에 적용됩니다.</p>
									</div>
									<br />
									<p class="fnt16">본 방침은 2012년 01월 01일부터 시행됩니다.</p>
									<!--e: 20200914 텍스트 수정-->
								</div>
								<div class="tab-menu-type02">
									<ul class="tab-list tab-list-3depth">
										<!--s: 20200914 띄어쓰기 추가-->
										<li>
											<a class="item" href="/privacy_policy_01"><span class="txt" data-id="">개인정보 처리방침</span></a>
										</li>
										<li class="active">
											<a class="item" href="#" onclick="return false;"><span class="txt" data-id="">개인정보 취급방침</span></a>
										</li>
										<li>
											<a class="item" href="/privacy_policy_03"><span class="txt" data-id="">영상정보처리기기 운영관리방침</span></a>
										</li>
										<!--e: 20200914 띄어쓰기 추가-->
									</ul>
								</div>
