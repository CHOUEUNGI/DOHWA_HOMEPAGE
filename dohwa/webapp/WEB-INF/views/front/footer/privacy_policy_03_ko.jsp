							...
							<div class="section-cont">
								...
								<div class="tab-menu-type02">
									<ul class="tab-list tab-list-3depth">
										...
										<li>
											<a class="item" href="/privacy_policy_02"><span class="txt" data-id="">개인정보 취급방침</span></a>
										</li>
										<li class="active">
											<a class="item" href="#" onclick="return false;"><span class="txt" data-id="">영상정보처리기기 운영관리방침</span></a>
										</li>
										<!--e: 20200914 띄어쓰기 추가-->
									</ul>
								</div>
