				...
				<div id="content" role="main">
					<div class="page-visual promotion01 visual-area">
						...
						<div class="noti-scroll none">
							<span class="txt"><spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.019" text="Scroll" /></span>
					...
					<div class="contents-wrap" style="position:relative">
						<div class="page-tab-section">
							<div class="tab-menu-type01 center">
								<ul class="tab-list">
									<li><a class="item" href="<c:url value="/prroom/ci" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.003" text="CI소개" /></a></li>
									<li class="active"><a class="item" href="<c:url value="/prroom/news" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.004" text="최신뉴스" /></a></li>
									<!--<c:if test="${'ko' eq _lang}">
										<li><a class="item" href="<c:url value="/prroom/press" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.020" text="보도자료" /></a></li>
									</c:if>-->
									<li><a class="item" href="<c:url value="/prroom/brochure" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.005" text="기업브로슈어" /></a></li>
									<li><a class="item" href="<c:url value="/prroom/promotional" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.006" text="홍보영상" /></a></li>
								</ul>
							</div>
						</div>
						<div class="contents no-btm-type clfix">
							<span class="page-decs">
								<strong>04 <spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.001" text="PR ROOM" /></strong>
							...
							<div class="section-cont first-cont">
								<div class="news-detail-wrap">
									<div class="news-head">
										...
										<span class="news-title"><span class="line-clamp" style="word-break: keep-all;"><c:out value="${boardVO.title}" /></span></span>
										<span class="news-index" style="width:150px"><c:out value="${boardVO.strRegDt}" /></span>
									</div>
									<div class="news-content">
										...
										<div class="news-desc"><c:out value="${boardVO.cont}" escapeXml="false" /></div>
									</div>
									<div class="bbs-bttn-area">
									<c:if test="${0 < fn:length(boardPrev)}">
										<a class="bttn-bbs-prev" href="<c:url value="/prroom/news/${boardPrev[0].seq}" />" title="<spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.012" text="이전" />">
									...
									<c:if test="${0 == fn:length(boardPrev)}">
										...
										<a class="bttn-bbs-list" href="<c:url value="/prroom/news" />" title="<spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.015" text="목록" />">
											<div class="hide-txt"><spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.015" text="목록" /></div>
										</a>

									<c:if test="${0 < fn:length(boardNext)}">
										<a class="bttn-bbs-next" href="<c:url value="/prroom/news/${boardNext[0].seq}" />" title="<spring:message code="FRONT.COMMON.MENU.PRROOM.002.002.016" text="다음" />">
