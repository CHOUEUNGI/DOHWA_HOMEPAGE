							...
							<div class="section-cont">
								...
								<div class="tab-wrap">
								      ...
								      <section class="acc-item">
								        ...
								        <div class="acc-panel" id="art2" hidden>
								          <div class="panel-inner">
											...
											<p>8. 환경영향평가업, 교통영향평가대행자, 재해영향평가대행자</p>
											<p>9. 방재안전대책수립대행업</p>
											<p>10. 환경컨설팅업</p>
											...
											<p>79. 산업부문(가스)-LNG배관, 공급시설 설계 및 공사업</p>
											...
											<p>88. 건설·엔지니어링 프로젝트 사업관리 용역업</p>
											<p>89. 토양관련전문기관(토양환경평가)조사</p>
											<p>90. 전문광해방지사업(토양개량 복원 및 정화사업)</p>
											<p>91. 위 각호에 관련된 제반 사업 및 투자</p>
								          </div>
								        </div>
								      </section>
								      <section class="acc-item">
								    ...
								    <div class="acc">
								    	<section class="acc-item">
										  ...
										  <div class="acc-panel" id="art29" hidden>
										    <div class="panel-inner">
										      <p>이 회사의 이사는 3명이상으로 하고, 독립이사는 이사 총 수의 3분의1 이상으로 한다.</p>
										    </div>
										  </div>
										</section>
										...
										<section class="acc-item">
										  <button class="acc-header" aria-expanded="false" aria-controls="art30_2">제30조의2 (독립이사 후보의 추천)</button>
										  <div class="acc-panel" id="art30_2" hidden>
										    <div class="panel-inner">
										      <p>① 독립이사후보추천위원회는 상법등 관련 법규에서 정한 자격을 갖춘 자 중에서 독립이사 후보를 추천한다</p>
										      <p>② 독립이사 후보의 추천 및 자격심사에 관한 세부적인 사항은 독립이사후보추천위원회에서 정한다.</p>
										    </div>
										  </div>
										</section>
										...
										<section class="acc-item">
										  ...
										  <div class="acc-panel" id="art32" hidden>
										    <div class="panel-inner">
										      ...
										      <p>② 독립이사가 사임․사망 등의 사유로 인하여 정관 제29조에서 정하는 원수를 결한 경우에는 그 사유가 발생한 후 최초로 소집되는 주주총회에서 그 요건에 충족되도록 하여야 한다.</p>
										    </div>
										  </div>
										</section>
										...
										<section class="acc-item">
										  <button class="acc-header" aria-expanded="false" aria-controls="art34_2">제34조의2(이사의 충실의무)</button>
										  <div class="acc-panel" id="art34_2" hidden>
										    <div class="panel-inner">
										      <p>① 이사는 회사 및 총주주의 이익을 보호하고 총주주에 대하여 공평하게 대우하여야 한다.</p>
										      <p>② 이사는 상법 제382조의3 및 자본시장과 금융투자업에 관한 법률 등 관련 법령에서 정하는 충실의무를 준수한다.</p>
										    </div>
										  </div>
										</section>
										...
										<section class="acc-item">
										  ...
										  <div class="acc-panel" id="art34_4" hidden>
										    <div class="panel-inner">
										      <p>① 이 회사는 주주총회 결의로 이사의 상법 제399조에 따른 책임을 그 행위를 한 날 이전 최근 1년 간의 보수액(상여금과</p>
										      <p>주식매수선택권의 행사로 인한 이익 등을 포함한다)의 6배(독립이사의 경우는 3배)를 초과하는 금액에 대하여 면제할 수 있다.</p>
								    	...
								    	<section class="acc-item">
										  ...
										  <div class="acc-panel" id="art39" hidden>
										    <div class="panel-inner">
										      ...
										      <p>③ 위원의 3분의 2 이상은 독립이사이어야 하고, 독립이사 아닌 위원은 상법 제542조의10 제2항의 요건을 갖추어야 한다.</p>
										      ...
										      <p>⑦ 감사위원회 위원의 선임과 해임에는 의결권 없는 주식을 제외한 발행주식총수의 100분의 3을 초과하는 수의 주식을 가진 주주</p> 
										      <p>(최대주주인 경우에는 그의 특수관계인, 그 밖에 상법시행령으로 정하는 자가 소유하는 주식을 합산한다)는 그 초과하는 주식에 관하여 의결권을 행사하지 못한다.</p>
										      <p>⑧ 감사위원회는 그 결의로 위원회를 대표할 자를 선정하여야 한다. 이 경우 위원장은 독립이사이어야 한다.</p>
										      <p>⑨ 독립이사의 사임·사망 등의 사유로 인하여 독립이사의 수가 이 조에서 정한 감사위원회의 구성요건에 미달하게 되면 그 사유가 발생한 후 처음으로 소집되는 주주총회에서 그 요건에 합치되도록 하여야 한다.</p>
										    </div>
										  </div>
										</section>
								  ...
								  <div id="tab-add" class="tab-content">
								    ...
								    <div class="acc">
								     	<section class="acc-item">
										  <button class="acc-header" aria-expanded="false" aria-controls="supplement-20260324">부칙(2026.03.24)</button>
										  <div class="acc-panel" id="supplement-20260324" hidden>
										    <div class="panel-inner">
										      <p>제1조(시행일) 이 정관은 주주총회에서 승인한 날(2026년 3월 24일)부터 시행한다. 다만, 제30조의2에서 독립이사는 <법률 제20991호> 부칙에 따라 법률의 시행전까지 상법 제542조의8에 따른 사외이사로 본다. </p>
										      <p>제2조(독립이사에 관한 경과조치) 제29조, 제32조, 제34조의4, 제39조(7항 제외) 개정규정은 2026년 7월 23일부터 시행한다.</p>
										      <p>제3조(감사위원 선․해임 시 의결권 제한에 관한 경과조치) 제39조 제7항 개정규정은 2026년 7월 23일부터 시행한다.</p>
										    </div>
										  </div>
										</section>
