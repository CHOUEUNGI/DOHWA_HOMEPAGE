								...
								<div class="chart-box col-02">
									<div class="box-left">
										...
										<div class="chart-area">
											<div id="chartNewOrdrAmt" style="width:100%; height:100%; min-height: 255px"></div>
										</div>
									</div>
									<div class="box-right">
										<div class="tit-area">
										...
										<div class="chart-area">
											<div id="chartOrdrBcklAmt" style="width:100%; height:100%; min-height: 255px"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="section-cont">
								...
								<div class="chart-box col-02">
									<div class="box-left">
										...
										<div class="chart-area">
											<div id="chartSalesAmt" style="width:100%; height:100%; min-height: 255px"></div>
										</div>
									</div>
									<div class="box-right">
										<div class="tit-area">
										...
										<div class="chart-area">
											<div id="chartOprtIncmAmt" style="width:100%; height:100%; min-height: 255px"></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="content-inner">
										...
										<table class="table-col-type01">
											...
											<tfoot>
												<tr>
													...
													<td><fmt:formatNumber value="${firstVO.totCptlAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.totCptlAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.totCptlAmt }" pattern="#,###" /></td>
												</tr>
											</tfoot>
											<tbody>
												<tr>
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.016" text="유동자산"/></td>
													<td><fmt:formatNumber value="${firstVO.currAsstAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.currAsstAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.currAsstAmt }" pattern="#,###" /></td>
												</tr>
												<tr>
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.017" text="비유동자산"/></td>
													<td><fmt:formatNumber value="${firstVO.nonCurrAsstAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.nonCurrAsstAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.nonCurrAsstAmt }" pattern="#,###" /></td>
												</tr>
												<tr class="total-cell">
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.013" text="자산총계"/></td>
													<td><fmt:formatNumber value="${firstVO.totAsstAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.totAsstAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.totAsstAmt }" pattern="#,###" /></td>
												</tr>
												<tr>
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.018" text="유동부채"/></td>
													<td><fmt:formatNumber value="${firstVO.currLbltAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.currLbltAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.currLbltAmt }" pattern="#,###" /></td>
												</tr>
												<tr>
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.019" text="비유동부채"/></td>
													<td><fmt:formatNumber value="${firstVO.nonCurrLbltAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.nonCurrLbltAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.nonCurrLbltAmt }" pattern="#,###" /></td>
												</tr>
												<tr class="total-cell">
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.014" text="부채총계"/></td>
													<td><fmt:formatNumber value="${firstVO.totLbltAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.totLbltAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.totLbltAmt }" pattern="#,###" /></td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div class="section-cont">
									...
									<div class="chart-box col-03">
										...
										<div class="box-left">
											<div class="tit-area">
												<strong class="chart-tit"><spring:message code="FRONT.COMMON.MENU.INVEST.001.001.009" text="영업이익"/></strong>
												<span class="chart-unit"><spring:message code="FRONT.COMMON.UNIT" text="단위" /> : <spring:message code="FRONT.COMMON.CURRENCY.02" text="억원" /></span>
											</div>
											<div class="chart-area">
										...
										<table class="table-col-type01">
											...
											<tfoot>
												<tr>
													...
													<td><fmt:formatNumber value="${firstVO.netIncmAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.netIncmAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.netIncmAmt }" pattern="#,###" /></td>
												</tr>
											</tfoot>
											<tbody id="tbodyAA">
												<tr>
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.001.008" text="영업수익"/></td>
													<td><fmt:formatNumber value="${firstVO.oprtRvnsAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.oprtRvnsAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.oprtRvnsAmt }" pattern="#,###" /></td>
												</tr>
												<tr>
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.010" text="영업비용"/></td>
													<td><fmt:formatNumber value="${firstVO.oprtAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.oprtAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.oprtAmt }" pattern="#,###" /></td>
												</tr>
												<tr>
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.006" text="영업이익"/></td>
													<td><fmt:formatNumber value="${firstVO.oprtIncmAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.oprtIncmAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.oprtIncmAmt }" pattern="#,###" /></td>
												</tr>
												<tr>
													<td><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.011" text="법인세비용 차감전순이익"/></td>
													<td><fmt:formatNumber value="${firstVO.incmBftxExpnAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${secondVO.incmBftxExpnAmt }" pattern="#,###" /></td>
													<td><fmt:formatNumber value="${lastVO.incmBftxExpnAmt }" pattern="#,###" /></td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div class="section-cont">
									...
									<div class="chart-box col-01">
										<div class="box-left">
											...
											<div class="chart-area" style="min-width: 1150px">
												<div id="chartSummary7" style="width:100%; height:100%; min-height: 447px"></div>
											</div>
										</div>
									</div>
									<div class="table-wrap-type01">
										<table class="table-col-type01">
											...
											<!--
												<tbody>
												<tr>
													<td rowspan="4"><spring:message code="FRONT.COMMON.MENU.INVEST.001.002.022" text="수익성"/></td>
													<td>ROE</td>
