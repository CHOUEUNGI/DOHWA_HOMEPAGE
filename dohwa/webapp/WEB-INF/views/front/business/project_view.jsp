				...
				<div id="content" role="main">
					<div class="page-visual business01 visual-area">
						...
						<div class="noti-scroll none">
							<span class="txt"><spring:message code="FRONT.COMMON.MENU.BUSINESS.002.002.017" text="Scroll" /></span>
					...
					<div class="contents-wrap" style="position:relative">
						<div class="page-tab-section">
							<div class="tab-menu-type01 center">
								<ul class="tab-list">
									<li><a class="item" href="<c:url value="/business" />" data-id=""><spring:message code="FRONT.COMMON.MENU.BUSINESS.002.002.003" text="Overview" /></a></li>
									<li class="active"><a class="item" href="<c:url value="/business/project" />" data-id=""><spring:message code="FRONT.COMMON.MENU.BUSINESS.002.002.004" text="Project" /></a></li>
								</ul>
							</div>
						</div>
						<div class="contents business-cont-wrap clfix" style="display:block;">
							...
							<div class="section-cont first-cont">
								<div class="bbs-view">
									...
									<div class="bbs-cont-area">
										...
										<div class="bbs-box-bd">
											<div class="inner-box">
												...
												<dl class="last-box">
													...
													<dd><span class="line-clamp"><c:out value="${projectVO.projectMlVO.client}" /></span></dd>
												</dl>
											</div>
										</div>
										...
										<div class="bbs-box-bd">
											<%-- <p class="bbx-box-txt">
												<span class="line-clamp"><c:out value="${fn:replace(projectVO.projectMlVO.cont, newLineChar, '<br/>')}" escapeXml="false"/></span>
											</p> --%>
									...
									<div class="bbs-bttn-area">
										<c:choose>
											<c:when test="${not empty param.searchType}">
												<a class="bttn-bbs-list" href="<c:url value="/business/project?searchType="/><c:out value="${param.searchType}"/>" title="<spring:message code="FRONT.COMMON.MENU.BUSINESS.002.002.016" text="목록" />">
													<div class="hide-txt"><spring:message code="FRONT.COMMON.MENU.BUSINESS.002.002.016" text="목록" /></div>
												</a>
											</c:when>
											<c:otherwise>
												<a class="bttn-bbs-list" href="<c:url value="/business/project" />" title="<spring:message code="FRONT.COMMON.MENU.BUSINESS.002.002.016" text="목록" />">
													<div class="hide-txt"><spring:message code="FRONT.COMMON.MENU.BUSINESS.002.002.016" text="목록" /></div>
												</a>
											</c:otherwise>
										</c:choose>
