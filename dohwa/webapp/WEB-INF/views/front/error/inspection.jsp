				...
				<div id="content" role="main">
					<div class="contents">
						<div class="section-cont">
							...
							<h2 class="title-sect"><spring:message code="FRONT.COMMON.MENU.ERROR.001.001" text="서비스 이용에 불편을 드려 죄송합니다." /></h2>
							<i class="ico-exmark" aria-hidden="true"></i>
							<div class="error-msg">
								<p><spring:message code="FRONT.COMMON.MENU.ERROR.001.002" text="현재는 사이트 점검 중입니다." /></p>
								<p><spring:message code="FRONT.COMMON.MENU.ERROR.001.003" text="빠른 시간 안에 정상 서비스하도록 하겠습니다. 감사합니다." /></p>
							</div>
							<div class="bttn-area">
								<a class="bttn type01 style02" href="/main">
									<span class="txt01"><spring:message code="FRONT.COMMON.MENU.ERROR.001.004" text="메인으로 돌아가기" /></span>
