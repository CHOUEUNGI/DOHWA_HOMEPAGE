				...
				<div id="content" role="main">
					...
					<div class="page-tab-section">
						<div class="tab-menu-type01 center">
							<ul class="tab-list">
								<li class="active"><a class="item" href="<c:url value="${mobileStartPath}prroom/ci" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.001.004" text="CI소개" /></a></li>
								<li><a class="item" href="<c:url value="${mobileStartPath}prroom/news" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.001.005" text="최신뉴스" /></a></li>
								<!--<c:if test="${'ko' eq _lang}">
									<li><a class="item" href="<c:url value="${mobileStartPath}prroom/press" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.001.037" text="보도자료" /></a></li>
								</c:if> -->
								<li><a class="item" href="<c:url value="${mobileStartPath}prroom/brochure" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.001.006" text="기업브로슈어" /></a></li>
								<li><a class="item" href="<c:url value="${mobileStartPath}prroom/promotional" />" data-id=""><spring:message code="FRONT.COMMON.MENU.PRROOM.001.007" text="홍보영상" /></a></li>
							</ul>
						</div>
					</div>
					<div class="symbol-keyword">
						<div class="inner">
							<div class="symbol-keyword-desc">
								...
								<div class="desc-txt">
									<spring:message code="FRONT.COMMON.MENU.PRROOM.001.010" text="<p>Logotype의 Simple한 형태 San Serif Style을 취한 것은</p>
											<p>최고의 기술력을 바탕으로 Hi-Technology지향하는</p>
											<p>기업의 사업 특성에 적합한 탄탄한 구조를 표현하고 있습니다.</p>" />
								</div>
							</div>
						...
						<div class="section-cont ci">
							<div class="content-inner">
									...
									<div class="color-define-box">
										<div class="inner-txt">
											...
											<p class="color-define-txt">
												<em><spring:message code="FRONT.COMMON.MENU.PRROOM.001.016" text="RGB Color" /></em>
												<span><spring:message code="FRONT.COMMON.MENU.PRROOM.001.017" text="R0&nbsp;&nbsp;G63&nbsp;&nbsp;B152" /></span>
											</p>
											<p class="color-define-txt">
												<em><spring:message code="FRONT.COMMON.MENU.PRROOM.001.018" text="Process Color" /></em>
												<span><spring:message code="FRONT.COMMON.MENU.PRROOM.001.019" text="C100&nbsp;&nbsp;M80&nbsp;&nbsp;Y0&nbsp;&nbsp;K0" /></span>
											</p>
										</div>
									</div>
								...
								<div class="ci-cont">
									...
									<div class="cont-desc">
										<spring:message code="FRONT.COMMON.MENU.PRROOM.001.025.1" text="CI의 레터마크는 기술을 나타내는 직선과 자연을 나타내는 곡선이 연결되어 물, 도시, 교통, 에너지 전반에서 최고의 기술력과 인재를 바탕으로 국내 엔지니어링 업계를 넘어 글로벌 기업으로서 ‘자연과 기술의 조화를 선도하는 도화의 길’을 나타냅니다." />
									</div>
								</div>
								<div class="ci-cont">
									...
									<div class="ci-type-box">
										<div class="type-kor">
											...
											<p class="cont-desc"><spring:message code="FRONT.COMMON.MENU.PRROOM.001.023.MOB" text="Type A는 미래를 향해 비상하는 끊임없는 도전과 상승을 의미합니다.끊김 없이 상승하는 라인은 한계를 넘어 도전하는 구성원들의 열정과 미래로 이어지는 뛰어난 기술력을 나타냅니다." /></p>
										</div>
										<div class="type-eng">
											<div class="ci-type-img">
												<img src="/images/pc/img_ci_graphic_b.jpg" alt="<spring:message code="FRONT.COMMON.MENU.PRROOM.001.022" text="도화 엔지니어링 심볼" />" />
											</div>
											<p class="cont-desc"><spring:message code="FRONT.COMMON.MENU.PRROOM.001.023.1.MOB" text="Type B는 길을 연상시키는 곡선 형태를 활용한 그래픽 모티브로, 도화가 지금껏 만들어온 역사, 그리고 새롭게 만들어 나갈 혁신의 길을 의미하며, Dohwa’s Way 로 명명됩니다." /></p>
										</div>
									</div>
								</div>
								...
								<div class="ci-cont">
									...
									<div class="bttn-area center clfix">
										<a class="bttn type01 style01 bttn-download" href="/upload/file_import/dohwa_ci_eng.pdf" title="<spring:message code="FRONT.COMMON.MENU.PRROOM.001.033" text="C.I PDF 다운로드" />">
										...
										<a class="bttn type01 style01 bttn-download" href="/upload/file_import/dohwa_ci_eng_ai.ai" title="<spring:message code="FRONT.COMMON.MENU.PRROOM.001.035" text="C.I AI 다운로드" />">
