...
<html lang="<%=response.getLocale().getLanguage()%>">
	...
	<body>
				...
				<div id="content" role="main">
					<div class="page-visual intro04 visual-area">
						<div class="page-title-sec">
							<span class="title-main-sub">HISTORY</span>
							<div class="title-main">
								<spring:message code="FRONT.COMMON.MENU.ABOUTUS.004.001.002.MOB" text="<p>끊임없는 성장과</p><p>혁신을 거듭해온</p><p>도화엔지니어링의</p><p>역사를 확인해보세요.</p>"/>
							</div>
						</div>
						<div class="noti-scroll">
							<span class="txt"><spring:message code="FRONT.COMMON.MENU.ABOUTUS.004.001.127" text="Scroll"/></span>
					...
					<div class="contents no-btm-type full-type">
						<div class="history-container">
							<div class="history-select">
								<!-- 1957 - 1970 -->
								<div class="history-select-item select-item01">
									<!-- 활성화시 .active 추가 -->
									<div class="inner-item">
										<a class="history-back-btn" href="#none">BACK</a>
										<a class="history-anchor" href="#none">
											<div class="desc">
												<em class="title-main">1957 - 1970</em>
												<p class="txt"><spring:message code="FRONT.COMMON.MENU.ABOUTUS.004.001.003" text="국내 토목건설 엔지니어링 산업의 기틀을 다진 도화의 시작"/></p>
									...
									<div class="inner-item">
										...
										<a class="history-anchor" href="#none">
											<div class="desc">
												...
												<p class="txt"><spring:message code="FRONT.COMMON.MENU.ABOUTUS.004.001.005" text="21세기 새로운 미래를 향한 발걸음" /></p>
												<i class="ico-arrow-right" aria-hidden="true"></i>
											</div>
										</a>
									</div>
							...
							<div class="progress-wrap">
								<!-- history-detail 활성화시 .on 추가 -->
								<div class="progress-inner">
									<a class="progress-anchor" href="#none">
										<!-- 활성화시 .active 추가 -->
										<div class="inner-txt"><em class="progress-tit">1957 - 1970</em></div>
										<span class="progress-line" aria-hidden="true"><span class="bar" style="width:10%;"></span></span>
									</a>
									<a class="progress-anchor" href="#none">
										<div class="inner-txt"><em class="progress-tit">1980 - 1990</em></div>
										<span class="progress-line" aria-hidden="true"><span class="bar" style="width:0;"></span></span>
									</a>
									<a class="progress-anchor" href="#none">
										<div class="inner-txt"><em class="progress-tit">2000’ s</em></div>
										<span class="progress-line" aria-hidden="true"><span class="bar" style="width:0;"></span></span>
									</a>
								</div>
							</div>
							<div class="history-detail detail01">
								...
								<div class="detail-container">
									<!-- 1957 - 1970 Detail -->
									<div class="history-detail-item detail-item01">
										<a class="history-back-btn2" href="#none">BACK</a>
										<div class="detail-content">
											<div class="inner-item">
												...
												<div class="detail-list">
													<a class="detail-anchor" href="#none">
												...
												<div class="detail-list">
													...
													<a class="detail-anchor" href="javascript:void(0);">
														...
														<div class="detail-desc">
															...
															<p class="tit"><spring:message code="FRONT.COMMON.MENU.ABOUTUS.004.001.130" text="ISO 37001 인증서 (국문)" /></p>
														</div>
													</a>
												</div>
											</div>
		...
		<script src="/inc/js/history_mo.js" type="text/javascript" charset="utf-8"></script>
		<script type="text/javascript">
		var history = new HistoryUI();
		</script>
	</body>
</html>